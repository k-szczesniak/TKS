...
//        Response responseFromAuthClient2 = authRequestClient2.post(new URI("https://localhost:8181/PAS/rest/auth"));
...
//
//        Response responseFromEmployment = employmentRequest.get(new URI("https://localhost:8181/PAS/rest/employment"));
...
//        Response response = request.get(new URI("https://localhost:8181/PAS/rest/employment"));
...
//        Response clientResponse = clientRequest.get(new URI("https://localhost:8181/PAS/rest/users"));
