...
public class OptionalTests {
    ...
    public void updateToken() throws URISyntaxException, InterruptedException {
        ...
        Response updateResponse = updateTokenRequest.get(new URI("https://localhost:8181/TKS/rest/auth/update"));
    ...
    public void resourcesETag() throws URISyntaxException {
        ...
        Response getResponse = getRequest.get(new URI("https://localhost:8181/TKS/rest/resources/" + uuid));
        ...
        Response responseFromPut = requestPut.put("https://localhost:8181/TKS/rest/resources/standard/" + uuid);
    ...
    public void usersETag() throws URISyntaxException {
        ...
        RequestSpecification getRequest = getBasicAdminRequest();
        Response getResponse = getRequest.get(new URI("https://localhost:8181/TKS/rest/users/" + uuid));
        String ETag = getResponse.header("ETag");
        ...
        Response responseFromPut = requestPut.put("https://localhost:8181/TKS/rest/users/admin/" + uuid);
        assertEquals(406, responseFromPut.statusCode());
    }
    ...
    public void updateTokenInactiveUser() throws URISyntaxException {
        ...
        Response clientResponse = clientRequest.get(new URI("https://localhost:8181/TKS/rest/auth/update"));
        ...
        clientResponse = clientRequest.get(new URI("https://localhost:8181/TKS/rest/auth/update"));
    ...
    private String getUUID(boolean fromResources, int number) throws URISyntaxException {
        ...
        if (fromResources) {
            getAllResponse = request.get(new URI("https://localhost:8181/TKS/rest/resources"));
        } else {
            getAllResponse = request.get(new URI("https://localhost:8181/TKS/rest/users"));
        }
