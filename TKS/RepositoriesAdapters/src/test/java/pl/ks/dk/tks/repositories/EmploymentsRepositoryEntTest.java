...
class EmploymentsRepositoryEntTest {
    ...
    void tryingToAddAddedElement() {
        ...
        assertThrows(RepositoryExceptionEnt.class, () -> employmentsRepository.addElement(employment));
    }
    ...
    void tryingToDeleteDeletedElement() {
        ...
        assertThrows(RepositoryExceptionEnt.class, () -> employmentsRepository.deleteElement(employment));
    }
}