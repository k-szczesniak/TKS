...
public class OptionalTests {
    ...
    public void updateToken() throws URISyntaxException, InterruptedException {
        ...
        Response updateResponse = updateTokenRequest.get(new URI("https://localhost:8181/UserService/rest/auth/update"));
    ...
    public void usersETag() throws URISyntaxException {
        ...
        Response getResponse = getRequest.get(new URI("https://localhost:8181/UserService/rest/users/" + uuid));
    ...
    public void updateTokenInactiveUser() throws URISyntaxException {
        ...
        Response clientResponse = clientRequest.get(new URI("https://localhost:8181/UserService/rest/auth/update"));
        ...
        clientResponse = clientRequest.get(new URI("https://localhost:8181/UserService/rest/auth/update"));
    ...
    private String getUUID(boolean fromResources, int number) throws URISyntaxException {
        ...
        if (fromResources) {
            getAllResponse = request.get(new URI("https://localhost:8181/UserService/rest/resources"));
        } else {
            getAllResponse = request.get(new URI("https://localhost:8181/UserService/rest/users"));
        }
